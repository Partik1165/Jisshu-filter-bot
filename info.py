...
USERNAME = environ.get("USERNAME", "umeshsaini1215")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002300895102, -1002281694959, -1002480100918, -1002435530987").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002354526516"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002441486687"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002957440355"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1002296975247"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1002276237804"))
...
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002471055093"))
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://envs.sh/cO8.jpg https://envs.sh/cO7.jpg",
    )
).split()
...
SUBSCRIPTION = environ.get(
    "SUBSCRIPTION", "https://envs.sh/cOo.jpg"
)
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
...
TMDB_API_KEY = environ.get("TMDB_API_KEY", "ecb8cf86332887dcabc4269cbac53f42")
...
if "DYNO" in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://open-charmain-umesh4q4w6-bfa27389.koyeb.app/")
