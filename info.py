...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "6727691050").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "BotZ_Umesh"
...
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002441486687"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002441486687"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002495186110"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1002495186110"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1002495186110"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://Movie1215:Movie1215@cluster0.y5yx7w2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get("DATABASE_NAME", "Cluster0")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "Movie_Download_Files")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "Movie_Download")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002403250184"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "-1002408539908"))
request_channel = environ.get("REQUEST_CHANNEL", "-1002441486687")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002354526516"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/Movie_DownIoad_Support")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/Movie_DownIoad")

# Verification
IS_VERIFY = is_enabled("IS_VERIFY", False)
# ---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/how_to_open_Iink")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/how_to_open_Iink")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/how_to_open_Iink")
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://envs.sh/P6p.jpg",
    )
).split()
FORCESUB_IMG = environ.get("FORCESUB_IMG", "https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg")
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/P6T.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://envs.sh/PX9.jpg")
).split()
SUBSCRIPTION = environ.get(
    "SUBSCRIPTION", "https://envs.sh/PXf.jpg"
)
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
...
TMDB_API_KEY = environ.get("TMDB_API_KEY", "7915349ed68b69af11002f5ea38aa8c6")
